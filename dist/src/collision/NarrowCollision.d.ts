...
export declare class NarrowCollision {
    ...
    static pointAndPolygon(point: PointI, polygon: PolygonI): boolean;
    ...
    static circleAndPolygon(circle: Circle, polygon: PolygonI): boolean;
    ...
    static lineAndPolygon(line: LineI, polygon: PolygonI): boolean;
    static polygonAndPolygon(polygonA: PolygonI, polygonB: PolygonI): boolean;
}
