...
describe('NarrowColission', () => {
    ...
    describe('pointAndPolygon()', () => {
        it('should return true if point collides with polygon', () => {
            const polygon = createPolygon(createPoint(2, 1), createPoint(2, 5), createPoint(6, 6), createPoint(8, 3), createPoint(5, 0));
    ...
    describe('circleAndPolygon()', () => {
        it('should return true if circle collides with polygon', () => {
            const polygon = createPolygon(createPoint(2, 1), createPoint(3, 5), createPoint(5, 5), createPoint(5, 3), createPoint(4, 0));
    ...
    describe('polygonAndPolygon()', () => {
        it('should return true if polygon collides with polygon', () => {
            const polygon = createPolygon(createPoint(2, 1), createPoint(3, 5), createPoint(5, 5), createPoint(5, 3), createPoint(4, 0));
            const polygon2 = createPolygon(createPoint(4, 4), createPoint(4, 6), createPoint(8, 6), createPoint(9, 1), createPoint(5, 0));
        ...
        it('should return false if polygon does not collide with polygon', () => {
            const polygon = createPolygon(createPoint(2, 1), createPoint(3, 5), createPoint(5, 5), createPoint(5, 3), createPoint(4, 0));
            const polygon2 = createPolygon(createPoint(6, 6), createPoint(6, 8), createPoint(8, 6), createPoint(9, 1), createPoint(5, 0));
...
const createRect = (corner, width, height) => ({
    corner,
    width,
    height,
});
...
const createTriangle = (vertexA, vertexB, vertexC) => ({
