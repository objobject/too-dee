...
describe('Matrix', () => {
    it('should construct matrix with 2D values', () => {
        ...
        expect(matrix.matrix).toMatchObject([
            [2, 1],
            [3, 2],
        ]);
    });
    it('add() should add matrices and update 2D values', () => {
        ...
        expect(matrix.add(matrix2).matrix).toMatchObject([
            [3, 4],
            [7, 4],
        ]);
    });
    it('addScalar() should add scalar to matrix 2D values', () => {
        ...
        expect(matrix.addScalar(2).matrix).toMatchObject([
            [4, 3],
            [5, 4],
        ]);
    });
    it('substract() should substract matrices and update 2D values', () => {
        ...
        expect(matrix.substract(matrix2).matrix).toMatchObject([
            [1, -2],
            [-1, 0],
        ]);
    });
    it('substractScalar() should add scalar to matrix 2D values', () => {
        ...
        expect(matrix.substractScalar(2).matrix).toMatchObject([
            [0, -1],
            [1, 0],
        ]);
    });
    it('multiply() should multiply matrices and update 2D values', () => {
        ...
        expect(matrix.multiply(matrix2).matrix).toMatchObject([
            [4, 9],
            [2, 5],
        ]);
    });
    it('multiplyScalar() should multiply matrix 2D values by scalar', () => {
        ...
        expect(matrix.multiplyScalar(3).matrix).toMatchObject([
            [6, 3],
            [9, 6],
        ]);
    });
